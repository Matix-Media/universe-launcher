            ...
            <div>
                ...
                <modal
                    ...
                    v-on:visitModpack="
                        $router.push({
                            ...
                            params: { id: $root.newsPopup.news.modpack.ID },
                        });
                        $root.newsPopup.visible = false;
                    "
                ...
                >
                    <div class="skeleton-loader" v-show="$root.newsPopup.loading">
                        <div
                            class="sk-bg"
                            style="width:20rem;height:1rem;margin-bottom:.5rem;"
                        ></div>
                        <div
                            class="sk-bg"
                            style="width:23rem;height:1rem;margin-bottom:.5rem;"
                        ></div>
                        <div
                            class="sk-bg"
                            style="width:13rem;height:1rem;margin-bottom:2rem;"
                        ></div>
                        <div
                            class="sk-bg"
                            style="width:18rem;height:1rem;margin-bottom:1rem;"
                        ></div>
                        <div
                            class="sk-bg"
                            style="width:25rem;height:1rem;margin-bottom:1rem;"
                        ></div>
                    </div>
                    <markdown-it-vue
                    ...
                    <template v-slot:header>
                        ...
                        >
                            <div
                                :style="{
                                    backgroundImage:
                                        'url(\'' + $root.newsPopup.news.modpack.icon + '\')',
                                }"
                                alt=""
                                class="icon"
                            ></div>
...
div.skeleton-loader .sk-bg {
    background-color: rgba(47, 54, 61, 0.8);
